...
export const en: Record<TranslationKey, string> = {
  ...
  'diary.edit': 'Correct',
  'diary.editSave': 'Save the correction',
  'diary.editCancel': 'Cancel',
  'diary.addExercise': 'Add an exercise to this workout',
  'diary.deleteWorkout': 'Delete the whole workout',
  'diary.deleteWorkoutOne': 'Delete the workout of {date} with its only exercise? This cannot be undone.',
  'diary.deleteWorkoutConfirm': 'Delete the workout of {date} with all its {count} exercises? This cannot be undone.',
